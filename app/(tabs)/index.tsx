...
const activities: { name: ActivityType; href: string; description: string; imageId: string }[] = [
	...
	{ name: 'Shuttle Run', href: '/activities/shuttle-run', description: 'Improve your speed and agility.', imageId: 'shuttle-run-card' },
	{ name: 'Endurance Run', href: '/activities/endurance-run', description: 'Boost your stamina over distance.', imageId: 'endurance-run-card' },
];

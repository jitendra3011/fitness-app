...
export default function Running() {
  ...
  try {
    ...
    const url = await uploadVideoAndSave(userId, 'Running', video.uri);
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.scanInfo}>
            <Text style={styles.scanText}>Running</Text>
            {isRecording && (
        ...
        <View style={styles.footer}>
          <Text style={styles.instructionText}>Should be in the frame to record Running</Text>
          {isRecording ? (

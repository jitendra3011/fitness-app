...
// export default function Longjump() {
...
//     const url = await uploadVideoAndSave(userId, 'Long Jump', video.uri);
...
//             <Text style={styles.scanText}>Long Jump</Text>
//             {isRecording && (
...
//           <Text style={styles.instructionText}>Stand in the frame to record Long Jump</Text>
//           {isRecording ? (
